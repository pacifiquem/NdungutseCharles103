...
const Projects = () => {
	...
	return (
		<div
			id="projects"
			className="flex pt-11 bg-gradient-to-b from-slate-100 via-slate-100 to-white w-full flex-col"
		>
			...
			<div className="flex items-center justify-center mt-4">
				...
				>
					Show All Works
					<p className="text-2xl ml-2">&rarr;</p>
				</p>
			</div>
...
const Work = ({ no, work }: any) => {
	...
	return (
      ...
      border-slate-200 shadow-md items-center p-[4%] gap-x-8 justify-center mt-[10vh] w-[80%] mx-auto ${
				no % 2 === 0 && "xtab:flex-row-reverse"
			}`}
		>
			<motion.div
				// ref={proref}
